...
use crate::handlers::get_submissions_handler::{get_submissions, get_submission_by_id, get_submissions_by_user_id};
...
pub fn create_router() -> Router {
    Router::new()
        ...
        .route("/user/{id}", get(get_submissions_by_user_id))
}
